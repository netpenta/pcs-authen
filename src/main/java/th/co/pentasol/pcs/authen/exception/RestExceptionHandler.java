package th.co.pentasol.pcs.authen.exception;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, @Nullable Object body, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        if (HttpStatus.INTERNAL_SERVER_ERROR.equals(status)) {
            error.setMessages(new ApiMessage(Message.ERROR, messageSource.getMessage("msg.internal.server.error", null, Locale.ENGLISH), null));
        }
        return new ResponseEntity(error, status);
    }
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, WebRequest request) {
        ...
        error.setMessages(new ApiMessage(Message.ERROR, messageSource.getMessage("msg.internal.server.error", null, request.getLocale()), null));
    ...
    public ResponseEntity<Object> handleServiceForbiddenException(ServiceException ex, WebRequest request) {
        ...
        error.setMessages(ex.getApiMessage());
        return new ResponseEntity<Object>(error, new HttpHeaders(), error.getStatus());
    }
}