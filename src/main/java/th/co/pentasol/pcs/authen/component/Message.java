package th.co.pentasol.pcs.authen.component;
...
public class Message {
    ...
    public ApiMessage getSavedMessage(Locale locale){
        return new ApiMessage(INFO, messageSource.getMessage(MSG_SAVE_SUCCESS, null, locale), null);
    }

    public ApiMessage getUpdatedMessage(Locale locale){
        return new ApiMessage(INFO, messageSource.getMessage(MSG_UPDATE_SUCCESS, null, locale), null);
    }

    public ApiMessage getDeletedMessage(boolean success, Locale locale){
        return new ApiMessage(INFO, messageSource.getMessage(success ? "msg.success.deleted.data" : "msg.failed.deleted.data", null, locale), null);
    }
    ...
    public ApiMessage getNotFoundMessage(Locale locale){
        return new ApiMessage(INFO, messageSource.getMessage(MSG_NOT_FOUND, null, locale), null);
    }

    public ApiMessage getInternalErrorMessage(Locale locale){
        return new ApiMessage(ERROR, messageSource.getMessage(MSG_INTERNAL_ERROR, null, locale), null);
    }
    ...
    public ApiMessage getForbiddebMessage(Locale locale){
        return new ApiMessage(INFO, messageSource.getMessage(MSG_FORBIDDEN, null, locale), null);
    }
    ...
    public ApiMessage getApiMessageInfo(String msg){
        return new ApiMessage(INFO, msg, null);
    }



    public ApiMessage getInvalidUserNameAndPasswordMessage(Locale locale){
        return new ApiMessage(WARNING, messageSource.getMessage(MSG_INVALID_USERNAME_PASSWORD, null, locale), null);
    }
